...
const UserSubscriptionSuccessPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (sessionId && amount && currency && chatId && userId) {
            setSession({
                id: sessionId,
                    ...
                    <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                        <div className="flex flex-col md:flex-row">
                            ...
                            <div className="w-full md:w-1/2 p-4 md:p-8">
                                ...
                                <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 text-center mb-6">Subscription Activated!</h1>
                                {session && (
                                    <div className="space-y-4 md:space-y-6">
                                        <p className="text-lg md:text-xl text-gray-700 text-center">Thank you for subscribing. Your mentor chat is now active!</p>
                                        <div className="bg-gray-50 px-4 py-3 md:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 rounded-lg">
                                            <div className="flex items-center">
                                                <FaCreditCard className="text-gray-500 mr-2" />
                                                <dt className="text-sm font-medium text-gray-500">Subscription Fee:</dt>
                                            </div>
