...
import { FaBook, FaRegClock, FaVideo, FaTrophy, FaFileDownload, FaRunning, FaClock, FaStar, FaShare } from "react-icons/fa";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-100 rounded-md p-6">
            ...
            <div className="flex justify-center items-center my-3">
              { AlreadyEnrolled? (
                 <button className="bg-darkBlue p-3 text-white font-bold w-full rounded-lg  transition duration-300 ease-in-out"
                 disabled>
                   Already Enrolled
                   </button>
              ):
              <button className="bg-darkBlue p-3 text-white font-bold w-full rounded-lg hover:bg-white hover:text-darkBlue transition duration-300 ease-in-out"
